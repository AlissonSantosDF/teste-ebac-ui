class EnderecoPage {
    ...
    editarEnderecoEntrega(nome, sobrenome , empresa, pais, endereco1, endereco2, cidade, estado, cep){
        cy.get('.woocommerce-MyAccount-navigation-link--edit-address > a').click()
        ...
        cy.get('#select2-shipping_country-container').type(pais).get('[aria-selected="true"]').click()
        cy.get('#shipping_address_1').clear().type(endereco1)
        cy.get('#shipping_address_2').clear().type(endereco2)
